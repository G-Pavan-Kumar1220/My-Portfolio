    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><Link  onClick={handelskillsPage}> <img className='header-nav-link-logo' src="https://cdn-icons-png.flaticon.com/128/4844/4844342.png" alt="" />Projects</Link></li>
                <li><Link  onClick={handelprojectsPage}><img className='header-nav-link-logo' src="https://cdn-icons-png.flaticon.com/128/10262/10262344.png" alt="" />Skills</Link></li>
            </ul>
        </nav>
    </header>
    </>
